...
insert into Marketplace (cost, badgeName, badgeDescription, imgURL) values (15000, "Six Months Sober", "Congratulations for your first step! It may not seem like much, but we are now your fans! It's time to Eradicate The Vape.", "images/six_months.png");
insert into Marketplace (cost, badgeName, badgeDescription, imgURL) values (18500, "One Year Sober", "Congratulations for your first step! It may not seem like much, but we are now your fans! It's time to Eradicate The Vape.", "images/one_year.png");
